...
var angularRoutePaths = ['/', '/items', '/my-items', '/new-item', '/items/{id}', '/search', '/edit-item/{id}', '/contact/{id}', '/{category}/items', '/en', '/en/items', '/en/my-items', '/en/new-item', '/en/items/{id}', '/en/search', '/en/edit-item/{id}', '/en/contact/{id}', '/en/{category}/items'];
